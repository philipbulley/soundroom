...
export class PlaylistMenuItemComponent {
  ...
  deleteMe() {
    ...
    if (!this.deleteState) {
      ...
      // The `deleteConfirm` Observable is no longer used with AsyncPipe in the template, as it was causing an error to be thrown when changing route in angular 2.0.0-beta.11
