...
@Component({
  ...
  providers: [...HTTP_PROVIDERS, PlaylistService, AuthService, NetworkService],
...
export class SoundroomComponent {
  ...
  constructor(authService:AuthService) {
    ...
    // TODO: Move load user into CanActivate? Where it can check existing user in memory or make a request
    // Load user
    // authService.load();
