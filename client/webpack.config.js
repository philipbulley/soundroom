...
module.exports = function makeWebpackConfig() {
  ...
  config.module = {
    ...
    loaders: [
      ...
      {
        test: /\.css$/,
        exclude: root('src', 'soundroom'),
        loader: isTest ? 'null' : ExtractTextPlugin.extract('style', 'css?sourceMap!postcss')
      },
      // all css required in src/soundroom files will be merged in js files
      {test: /\.css$/, include: root('src', 'soundroom'), loader: 'raw!postcss'},
    ...
    config.plugins.push(
      ...
      new HtmlWebpackPlugin({
        ...
        chunksSortMode: function compare(a, b) {
          ...
          // soundroom always last
          if (a.names[0] === 'soundroom') {
            return 1;
          }
          // vendor before soundroom
          if (a.names[0] === 'vendor' && b.names[0] === 'soundroom') {
            return -1;
          } else {
            return 1;
          }
